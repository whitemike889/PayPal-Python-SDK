...
class AuthorizationReauthorizeRequest:
    ...
    def __init__(self, authorization_id):
        self.verb = "POST"
        self.path = "/v1/payments/authorization/{authorization_id}/reauthorize?".replace("{authorization_id}", quote(str(authorization_id)))
        self.headers = {}
    ...
    def request_body(self, authorization):
